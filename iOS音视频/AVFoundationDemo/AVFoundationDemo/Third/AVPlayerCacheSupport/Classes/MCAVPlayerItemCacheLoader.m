...
{
//    NSLog(@"loadingRequest.dataRequest.range ==== %@, %@, %@", NSStringFromRange(NSMakeRange(loadingRequest.dataRequest.requestedOffset, loadingRequest.dataRequest.requestedLength)), loadingRequest.contentInformationRequest, loadingRequest.dataRequest);
